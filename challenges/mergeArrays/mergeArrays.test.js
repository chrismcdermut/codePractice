...
const testOne = {
  input: [[3, 4, 6, 10, 11, 15], [1, 5, 8, 12, 14, 19],[2,13,20,21]],
  output: [1, 2,3, 4, 5, 6, 8, 10, 11, 12,13, 14, 15, 19,20,21]
}

const testTwo = {
  input: [[3, 4, 6, 10, 11, 15], [1, 5, 8], [2,7,9]],
...
xdescribe('mergeArrays Test', () => {
  ...
  test('testTwo', ()=>{
    let result = mergeArrays(testTwo.input)
    expect(result).toEqual(testTwo.output);
  })

  test('testThree', ()=>{
    let result = mergeArrays(testThree.input)
    expect(result).toEqual(testThree.output);
  })

  test('testFour', ()=>{
    let result = mergeArrays(testFour.input)
    expect(result).toEqual(testFour.output);
  })

  xtest('testFive', ()=>{
    let result = mergeArrays(testFive.input)
