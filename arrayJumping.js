...
const jumpToZero = (array, startingIndex) => {
  console.log('function running')
   ...
   //  };
    ...
    let JumpRightTarget = startingIndex+array[startingIndex]
    let JumpLeftTarget = startingIndex-array[startingIndex];

    if(array[startingIndex] === 0 || array[JumpRightTarget]===0 || array[JumpLeftTarget]===0){
      console.log(true);
      return true;
    }
